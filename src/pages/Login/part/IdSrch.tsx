         ...
         <Header/>
          ...
          <main className="container">
            <div className="member_inner">
              ...
              <Link to={pathGenerator(PAGES.LOGIN) +'/IdSrch'} className="btn active">아이디 찾기</Link>
              <Link to={pathGenerator(PAGES.LOGIN) +'/PWSrch'} className="btn">비밀번호 찾기</Link>
              </div>
                  ...
                  <div className="join_wrap type_srch">
                    <div className="input_wrap">
                      ...
                      <div className="input_area input_btn">
                        ...
                        <button type="button" className="btn">인증번호 발송</button>
                      </div>
              ...
              <div className="popup_layer"> 
                ...
                <div className="popup_inner">
                  ...
                  <div className="srch_result">
                    <p>홍길동 회원님의 아이디는 <strong>ho*******ng</strong> 입니다.</p>
                  </div>
                  <div className="btn_area type_02">
                    <Link to={pathGenerator(PAGES.LOGIN) + '/PWSrch'} className="btn form02">비밀번호 찾기</Link>
