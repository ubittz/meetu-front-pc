              ...
              <div className='join_wrap'>
                ...
                <div className='terms_wrap'>
                  <div className='chk_area chkAll'>
                    <input type='checkbox' name='termsChkAll' id='termsChkAll' checked={isAllChecked} onChange={handleAllChecked} />
                  ...
                  <div className='chk_area'>
                    ...
                    {isShowTerms.terms03 && (
                      <p className='txt_area' style={{ display: 'block' }}>
                        ...
                        정보주체에게 안내하고 동의를 받습니다. 정보주체에게는 개인정보의 수집 및 이용을 거부할 권리가 있으나, 아래 개인정보 수집 관련
                        사항은 서비스 제공을 위한 최소한의 개인정보 수집으로서 본 동의를 거부하실 경우, 서비스 이용이 불가능합니다. <br />
                        <br />
                        1. 수집하는 개인정보 항목 <br />
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이메일/법정대리인의 이름, 생년월일, 주소, 연락처, 이메일), 가족관계증명서(또는 법정대리인 <br />
                        ...
                        <br />
                        밋유 스토어는 특정 금융거래정보의 보고 및 이용 등에 관한 법률 5 조 2 항에 따른 자금세탁 방지 의무를 준수하기 위해 각 사업장의
                        신원확인 대상자에 대해 아래와 같은 개인정보를 수집합니다. <br />
                        <br />
                        [고객 확인제도 등록정보]
                        <br />
                        ...
                        [내부정책에 의한 정보보유 사유]
                        <br />
                        1. - 보유 정보: 아이디, CI(암호화된 동일인 식별정보), 여권번호/해외 거주 증명 <br /> &nbsp;&nbsp;&nbsp;&nbsp;ID 카드 번호{' '}
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - 보유 이유: 재가입 신청 방지 <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - 보존 기간: 탈퇴 후 30 일간 보관 <br />
                        2. - 보유정보 : 고객신원확인 대상자의 성명, 성별, 국적, 생년월일, CI, 주민등록번호, 여권번호, 거주지 주소, 연락처 <br />
                        &nbsp;&nbsp;- 보존이유 : 특정금융거래정보의 보고 및 이용등에 관한 법률 제 5 조의 2 및 동법 시행령 <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;제 10 조의 4 에 따라 수집 및 보유 <br />
                ...
                <div className='btn_area type_02'>
                  ...
                  <Link to={pathGenerator(PAGES.REGISTER) + '/1'} className={`btn ${isNextDisabled ? 'disabled' : ''}`}>
                    다음
                  </Link>
                  {/* </button> */}
                </div>
