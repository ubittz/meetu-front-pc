...
!(function (t) {
        ...
        ? ((_ = 'string' == typeof (u = V.extend({}, u)).of ? V(document).find(u.of) : V(u.of)),
          ...
          V.each(['my', 'at'], function () {
            var t,
              e,
              i = (u[this] || '').split(' ');
            ((i = 1 === i.length ? (o.test(i[0]) ? i.concat(['center']) : a.test(i[0]) ? ['center'].concat(i) : ['center', 'center']) : i)[0] =
              o.test(i[0]) ? i[0] : 'center'),
              ...
              u.using &&
                (t = function (t) {
                  ...
                  p < r && x(e + i) < p && (o.horizontal = 'center'),
                    ...
                    k(x(e), x(i)) > k(x(s), x(n)) ? (o.important = 'horizontal') : (o.important = 'vertical'),
        ...
        left: function (t, e) {
          ...
          i < e.collisionWidth
            ? 0 < o && a <= 0
              ...
              : (t.left = !(0 < a && o <= 0) && a < o ? s + i - e.collisionWidth : s)
            : 0 < o
              ? (t.left += o)
              : 0 < a
                ? (t.left -= a)
        ...
        top: function (t, e) {
          ...
          s < e.collisionHeight
            ? 0 < o && a <= 0
              ...
              : (t.top = !(0 < a && o <= 0) && a < o ? i + s - e.collisionHeight : i)
            : 0 < o
              ? (t.top += o)
              : 0 < a
                ? (t.top -= a)
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[0];
          a < 0
            ? ((n = t.left + r + l + h + e.collisionWidth - n - s) < 0 || n < x(a)) && (t.left += r + l + h)
            : 0 < o && (0 < (s = t.left - e.collisionPosition.marginLeft + r + l + h - i) || x(s) < o) && (t.left += r + l + h);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[1];
          a < 0
            ? ((n = t.top + r + l + h + e.collisionHeight - n - s) < 0 || n < x(a)) && (t.top += r + l + h)
            : 0 < o && (0 < (s = t.top - e.collisionPosition.marginTop + r + l + h - i) || x(s) < o) && (t.top += r + l + h);
        },
      },
      flipfit: {
        left: function () {
    ...
    (V.ui.focusable = function (t, e) {
      ...
      return 'area' === o
        ? ((n = (i = t.parentNode).name),
          !(!t.href || !n || 'map' !== i.nodeName.toLowerCase()) && 0 < (i = V("img[usemap='#" + n + "']")).length && i.is(':visible'))
        : (/^(input|select|textarea|button|object)$/.test(o)
            ? (s = !t.disabled) && (n = V(t).closest('fieldset')[0]) && (s = !n.disabled)
            : (s = ('a' === o && t.href) || e),
          ...
          e.containment
            ? 'window' === e.containment
              ? (this.containment = [
                  ...
                  V(window).scrollTop() + (V(window).height() || i.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
                ])
              : 'document' === e.containment
                ? (this.containment = [
                    0,
                    0,
                    V(i).width() - this.helperProportions.width - this.margins.left,
                    (V(i).height() || i.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
                  ])
                  ...
                  : ('parent' === e.containment && (e.containment = this.helper[0].parentNode),
                    (e = (i = V(e.containment))[0]) &&
                      ...
                      (this.containment = [
                        ...
                        (t ? Math.max(e.scrollWidth, e.offsetWidth) : e.offsetWidth) -
                          (parseInt(i.css('borderRightWidth'), 10) || 0) -
                          (parseInt(i.css('paddingRight'), 10) || 0) -
                          this.helperProportions.width -
                          this.margins.left -
                          this.margins.right,
                        (t ? Math.max(e.scrollHeight, e.offsetHeight) : e.offsetHeight) -
      ...
      _convertPositionTo: function (t, e) {
        ...
        return {
          top:
            ...
            ('fixed' === this.cssPosition ? -this.offset.scroll.top : i ? 0 : this.offset.scroll.top) * t,
          left:
            e.left +
            this.offset.relative.left * t +
            this.offset.parent.left * t -
            ('fixed' === this.cssPosition ? -this.offset.scroll.left : i ? 0 : this.offset.scroll.left) * t,
        };
      },
          ...
          (n && this.offset.scroll) || (this.offset.scroll = { top: this.scrollParent.scrollTop(), left: this.scrollParent.scrollLeft() }),
          {
            top:
              (a =
                ...
                (this.containment &&
                  ((i = this.relativeContainer
                    ? ((e = this.relativeContainer.offset()),
                      [this.containment[0] + e.left, this.containment[1] + e.top, this.containment[2] + e.left, this.containment[3] + e.top])
                    : this.containment),
                ...
                s.grid &&
                  ((e = s.grid[1] ? this.originalPageY + Math.round((a - this.originalPageY) / s.grid[1]) * s.grid[1] : this.originalPageY),
                  (a =
                    !i || e - this.offset.click.top >= i[1] || e - this.offset.click.top > i[3]
                      ? e
            ...
            g < r - p || l + p < f || _ < h - p || c + p < m || !V.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item)
              ...
              : ('inner' !== d.snapMode &&
                ...
                'outer' !== d.snapMode &&
                  ...
                  a) &&
                  (e.position.left = i._convertPositionTo('relative', { top: 0, left: l - i.helperProportions.width }).left),
                !i.snapElements[v].snapping &&
                  (s || n || o || a || u) &&
                  i.options.snap.snap &&
        ...
        n.options.refreshPositions && V.ui.ddmanager.prepareOffsets(n, o),
          V.each(V.ui.ddmanager.droppables[n.options.scope] || [], function () {
            ...
            this.options.disabled ||
              this.greedyChild ||
              !this.visible ||
              ((s = !(s = V.ui.intersect(n, this, this.options.tolerance, o)) && this.isover ? 'isout' : s && !this.isover ? 'isover' : null) &&
                (this.options.greedy &&
                  ((e = this.options.scope),
                  (i = this.element.parents(':data(ui-droppable)').filter(function () {
                    return V(this).droppable('instance').options.scope === e;
                  })).length) &&
                  ((t = V(i[0]).droppable('instance')).greedyChild = 'isover' === s),
    ...
    V.widget('ui.resizable', V.ui.mouse, {
      ...
      _mouseDrag: function (t) {
        ...
        return (
          ...
          i &&
            ...
            V.isEmptyObject(s) || (this._updatePrevProperties(), this._trigger('resize', t, this.ui()), this._applyChanges())),
          !1
        );
      },
      _mouseStop: function (t) {
        ...
        return (
          this._helper &&
            ...
            (e = { width: o.helper.width() - e, height: o.helper.height() - i }),
      ...
      _applyChanges: function () {
        ...
        return (
          ...
          this.helper.css(t),
          this.size.width !== this.prevSize.width && ((t.width = this.size.width + 'px'), this.helper.width(t.width)),
          this.size.height !== this.prevSize.height && ((t.height = this.size.height + 'px'), this.helper.height(t.height)),
          t
        );
      },
        ...
        a &&
          ...
          /document/.test(o) || o === document
            ...
            : ((i = V(a)),
              ...
              (n.parentData = { element: a, left: o.left, top: o.top, width: t, height: e })));
      },
      resize: function (t) {
        ...
        a[0] !== document && /static/.test(a.css('position')) && (o = s),
          n.left < (e._helper ? s.left : 0) &&
            ((e.size.width = e.size.width + (e._helper ? e.position.left - s.left : e.position.left - o.left)),
      ...
      resize: function () {
        ...
        (i.grid = r),
          ...
          /^(se|s|e)$/.test(a)
            ...
            : /^(ne)$/.test(a)
              ? ((e.size.width = u), (e.size.height = d), (e.position.top = o.top - s))
              : /^(sw)$/.test(a)
                ? ((e.size.width = u), (e.size.height = d), (e.position.left = o.left - c))
                : ((d - h <= 0 || u - l <= 0) && (t = e._getPaddingPlusBorderDimensions(this)),
                  0 < d - h
                    ? ((e.size.height = d), (e.position.top = o.top - s))
                    : ((d = h - t.height), (e.size.height = d), (e.position.top = o.top + n.height - d)),
                  0 < u - l
                    ? ((e.size.width = u), (e.position.left = o.left - c))
                    : ((u = l - t.width), (e.size.width = u), (e.position.left = o.left + n.width - u)));
      },
    }),
    V.ui.resizable,
          ...
          return (
            ...
            this.selectees.each(function () {
              ...
              t &&
                ...
                'touch' === o.tolerance
                  ? (e = !(l < i.left || i.right < a || h < i.top || i.bottom < r))
                  : 'fit' === o.tolerance && (e = a < i.left && i.right < l && r < i.top && i.bottom < h),
                e
    ...
    V.widget('ui.sortable', V.ui.mouse, {
      ...
      _mouseStart: function (t, e, i) {
        ...
        if (
          ...
          o.cursor &&
            'auto' !== o.cursor &&
            ((n = this.document.find('body')), (this._storedStylesheet = V('<style>*{ cursor: ' + o.cursor + ' !important; }</style>').appendTo(n))),
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              V.contains(this.containers[u].element[0], this.items[e].item[0]) &&
                ...
                ((a = this.items[e].item.offset()[n]), (r = !1), t[h] - a > this.items[e][o] / 2 && (r = !0), Math.abs(t[h] - a) < i) &&
      ...
      _getParentOffset: function () {
        ...
        return (
          ...
          {
            top:
              (t = this.offsetParent[0] === this.document[0].body ? { top: 0, left: 0 } : t).top +
              (parseInt(this.offsetParent.css('borderTopWidth'), 10) || 0),
            left: t.left + (parseInt(this.offsetParent.css('borderLeftWidth'), 10) || 0),
          }
        );
      ...
      _setContainment: function () {
        ...
        'parent' === i.containment && (i.containment = this.helper[0].parentNode),
          ...
          /^(document|window|parent)$/.test(i.containment) ||
            ...
            (this.containment = [
              i.left + (parseInt(V(t).css('borderLeftWidth'), 10) || 0) + (parseInt(V(t).css('paddingLeft'), 10) || 0) - this.margins.left,
              i.top + (parseInt(V(t).css('borderTopWidth'), 10) || 0) + (parseInt(V(t).css('paddingTop'), 10) || 0) - this.margins.top,
              i.left +
      ...
      _convertPositionTo: function (t, e) {
        ...
        return {
          top:
            ...
            this.offset.relative.top * t +
            this.offset.parent.top * t -
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : i.scrollTop()) * t,
          left:
            e.left +
            this.offset.relative.left * t +
            this.offset.parent.left * t -
            ('fixed' === this.cssPosition ? -this.scrollParent.scrollLeft() : s ? 0 : i.scrollLeft()) * t,
        };
      },
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault(),
          (n && !e.collapsible) ||
            ...
            e.icons &&
              ((a = i.children('.ui-accordion-header-icon')), this._removeClass(a, null, e.icons.activeHeader)._addClass(a, null, e.icons.header)),
            n) ||
            (this._removeClass(s, 'ui-accordion-header-collapsed')._addClass(s, 'ui-accordion-header-active', 'ui-state-active'),
            e.icons &&
              ((t = s.children('.ui-accordion-header-icon')), this._removeClass(t, null, e.icons.header)._addClass(t, null, e.icons.activeHeader)),
                ...
                step: function (t, e) {
                  (e.now = Math.round(t)),
                    'height' !== e.prop
                      ...
                      : 'content' !== o.options.heightStyle && ((e.now = Math.round(n - i.outerHeight() - a)), (a = 0));
                },
              }))
    ...
    V.widget('ui.menu', {
      ...
      refresh: function () {
        ...
        this._toggleClass('ui-menu-icons', null, !!this.element.find('.ui-icon').length),
          ...
          (e = (i = t.not('.ui-menu-item, .ui-menu-divider')).children().not('.ui-menu').uniqueId().attr({ tabIndex: -1, role: this._itemRole() })),
    ...
    V.widget('ui.autocomplete', {
      ...
      _create: function () {
        ...
        (this.isMultiLine = e || (!t && 'true' === this.element.prop('contentEditable'))),
          ...
          this._initSource(),
          (this.menu = V('<ul>').appendTo(this._appendTo()).menu({ role: null }).hide().menu('instance')),
          ...
          this._on(this.menu.element, {
            ...
            menufocus: function (t, e) {
              var i, s;
              this.isNewMenu && ((this.isNewMenu = !1), t.originalEvent) && /^mouse/.test(t.originalEvent.type)
                ? (this.menu.blur(),
            ...
            menuselect: function (t, e) {
              var e = e.item.data('ui-autocomplete-item'),
                i = this.previous;
              this.element[0] !== this.document[0].activeElement && (this.element.trigger('focus'), (this.previous = i)),
                !1 !== this._trigger('select', t, { item: e }) && this._value(e.value),
      ...
      _appendTo: function () {
        ...
        return (t = (t =
          (t = t && (t.jquery || t.nodeType ? V(t) : this.document.find(t).eq(0))) && t[0] ? t : this.element.closest('.ui-front, dialog')).length
          ? t
    ...
    V.widget('ui.checkboxradio', [
      V.ui.formResetMixin,
      {
        ...
        _setOption: function (t, e) {
          ('label' === t && !e) ||
            (this._super(t, e),
            'disabled' === t ? (this._toggleClass(this.label, null, 'ui-state-disabled', e), (this.element[0].disabled = e)) : this.refresh());
        },
  ...
  function j() {
    V.datepicker._isDisabledDatepicker((d.inline ? d.dpDiv.parent() : d.input)[0]) ||
    ...
    V.extend(Y.prototype, {
      ...
      _newInst: function (t, e) {
        return {
          ...
          inline: e,
          dpDiv: e
            ? B(V("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
            : this.dpDiv,
        };
      },
      ...
      _enableDatepicker: function (e) {
        ...
        i.hasClass(this.markerClassName) &&
          ('input' === (t = e.nodeName.toLowerCase())
            ...
            : ('div' !== t && 'span' !== t) ||
              ((s = i.children('.' + this._inlineClass)).children().removeClass('ui-state-disabled'),
      ...
      _disableDatepicker: function (e) {
        ...
        i.hasClass(this.markerClassName) &&
          ('input' === (t = e.nodeName.toLowerCase())
            ...
            : ('div' !== t && 'span' !== t) ||
              ((s = i.children('.' + this._inlineClass)).children().addClass('ui-state-disabled'),
            ...
            case 13:
              return (
                ...
                (i = V.datepicker._get(s, 'onSelect'))
                  ? ((e = V.datepicker._formatDate(s)), i.apply(s.input ? s.input[0] : null, [e, s]))
                  : V.datepicker._hideDatepicker(),
                !1
              );
            case 27:
      ...
      _doKeyPress: function (t) {
        ...
        if (V.datepicker._get(i, 'constrainInput'))
          return (
            (i = V.datepicker._possibleChars(V.datepicker._get(i, 'dateFormat'))),
      ...
      _showDatepicker: function (t) {
        ...
        'input' !== (t = t.target || t).nodeName.toLowerCase() && (t = V('input', t.parentNode)[0]),
          V.datepicker._isDisabledDatepicker(t) ||
            ...
            !1 === (i = (i = V.datepicker._get(n, 'beforeShow')) ? i.apply(t, [t, n]) : {})) ||
            (p(n.settings, i),
            (n.lastVal = null),
            (V.datepicker._lastInput = t),
        ...
        !s ||
          ...
          (this._datepickerShowing &&
            ...
            V.effects && V.effects.effect[t]
              ...
              : s.dpDiv['slideDown' === t ? 'slideUp' : 'fadeIn' === t ? 'fadeOut' : 'hide'](t ? i : null, e),
            t || e(),
            (this._datepickerShowing = !1),
            (i = this._get(s, 'onClose')) && i.apply(s.input ? s.input[0] : null, [s.input ? s.input.val() : '', s]),
            (this._lastInput = null),
            this._inDialog &&
              (this._dialogInput.css({ position: 'absolute', left: '0', top: '-100px' }), V.blockUI) &&
      ...
      _checkExternalClick: function (t) {
        ...
        V.datepicker._curInst &&
          ...
          !(
            ...
            (t.hasClass(V.datepicker.markerClassName) && V.datepicker._curInst !== e)) &&
          V.datepicker._hideDatepicker();
      },
      ...
      _selectMonthYear: function (t, e, i) {
        var t = V(t),
          s = this._getInst(t[0]);
        (s['selected' + ('M' === i ? 'Month' : 'Year')] = s['draw' + ('M' === i ? 'Month' : 'Year')] =
      ...
      parseDate: function (e, n, t) {
        ...
        for (
          var i,
            s,
            o = 0,
            a = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff,
            ...
            h = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort,
        ...
        if (
          (-1 === u
            ...
            : u < 100 && (u += new Date().getFullYear() - (new Date().getFullYear() % 100) + (u <= a ? 0 : -100)),
          -1 < f)
        )
          for (d = 1, p = f; ; ) {
            ...
            null == t || '' === t
              ...
              : 'string' == typeof t
                ...
                : 'number' == typeof t
                  ...
                  : new Date(t.getTime());
        return (
          (s = s && 'Invalid Date' === s.toString() ? e : s) && (s.setHours(0), s.setMinutes(0), s.setSeconds(0), s.setMilliseconds(0)),
      ...
      _generateHTML: function (t) {
        ...
        if ((A < 0 && ((A += 12), E--), O))
          for (
            e = this._daylightSavingAdjust(new Date(O.getFullYear(), O.getMonth() - P[0] * P[1] + 1, O.getDate())), e = z && e < z ? z : e;
        ...
        for (
          t.drawMonth = A,
            ...
            i = this._canAdjustMonth(t, -1, E, A)
              ? V('<a>')
                  .attr({ class: 'ui-datepicker-prev ui-corner-all', 'data-handler': 'prev', 'data-event': 'click', title: M })
                  .append(
                    V('<span>')
                      .addClass('ui-icon ui-icon-circle-triangle-' + (D ? 'e' : 'w'))
                      .text(M)
                  )[0].outerHTML
              : I
                ? ''
                : V('<a>')
                    .attr({ class: 'ui-datepicker-prev ui-corner-all ui-state-disabled', title: M })
                    .append(
                      V('<span>')
                        .addClass('ui-icon ui-icon-circle-triangle-' + (D ? 'e' : 'w'))
                        .text(M)
            ...
            s = this._canAdjustMonth(t, 1, E, A)
              ? V('<a>')
                  .attr({ class: 'ui-datepicker-next ui-corner-all', 'data-handler': 'next', 'data-event': 'click', title: M })
                  .append(
                    V('<span>')
                      .addClass('ui-icon ui-icon-circle-triangle-' + (D ? 'w' : 'e'))
                      .text(M)
                  )[0].outerHTML
              : I
                ? ''
                : V('<a>')
                    .attr({ class: 'ui-datepicker-next ui-corner-all ui-state-disabled', title: M })
                    .append(
                      V('<span>')
                        .attr('class', 'ui-icon ui-icon-circle-triangle-' + (D ? 'w' : 'e'))
                        .text(M)
                    )[0].outerHTML,
          ...
          for (d = '', this.maxRows = 4, p = 0; p < P[1]; p++) {
            ...
            for (
              m +=
                ...
                this._generateMonthYearHeader(t, A, E, z, O, 0 < u || 0 < p, F, L) +
              ...
              _ +=
                "<th scope='col'" +
                (5 <= (c + n + 6) % 7 ? " class='ui-datepicker-week-end'" : '') +
                "><span title='" +
                N[(Y = (c + n) % 7)] +
                "'>" +
                W[Y] +
            ...
            for (
              ...
              for (m += '<tr>', q = o ? "<td class='ui-datepicker-week-col'>" + this._get(t, 'calculateWeek')(y) + '</td>' : '', c = 0; c < 7; c++)
                (w = a ? a.apply(t.input ? t.input[0] : null, [y]) : [!0, '']),
                  (x = ((k = y.getMonth() !== A) && !R) || !w[0] || (z && y < z) || (O && O < y)),
                  (q +=
                    "<td class='" +
                    (5 <= (c + n + 6) % 7 ? ' ui-datepicker-week-end' : '') +
                    (k ? ' ui-datepicker-other-month' : '') +
                    ((y.getTime() === f.getTime() && A === t.selectedMonth && t._keyEvent) ||
                    (l.getTime() === y.getTime() && l.getTime() === f.getTime())
                      ? ' ' + this._dayOverClass
                      : '') +
                    (x ? ' ' + this._unselectableClass + ' ui-state-disabled' : '') +
                    (k && !r
                      ? ''
                      : ' ' +
                        w[1] +
                        (y.getTime() === H.getTime() ? ' ' + this._currentClass : '') +
                        (y.getTime() === K.getTime() ? ' ui-datepicker-today' : '')) +
                    "'" +
                    ((k && !r) || !w[2] ? '' : " title='" + w[2].replace(/'/g, '&#39;') + "'") +
                    (x ? '' : " data-handler='selectDay' data-event='click' data-month='" + y.getMonth() + "' data-year='" + y.getFullYear() + "'") +
                    '>' +
                    (k && !r
                      ? '&#xa0;'
                      : x
                        ...
                        : "<a class='ui-state-default" +
                          (y.getTime() === K.getTime() ? ' ui-state-highlight' : '') +
                          (y.getTime() === H.getTime() ? ' ui-state-active' : '') +
            ...
            11 < ++A && ((A = 0), E++),
              (d += m +=
                '</tbody></table>' + (U ? '</div>' + (0 < P[0] && p === P[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '') : ''));
          }
          h += d;
        }
  ...
  V.widget('ui.dialog', {
    ...
    _focusTabbable: function () {
      ...
      (t = (t = (t = (t = (t = t || this.element.find('[autofocus]')).length ? t : this.element.find(':tabbable')).length
        ? t
    ...
    _createWrapper: function () {
      (this.uiDialog = V('<div>')
        ...
        this._on(this.uiDialog, {
          keydown: function (t) {
            var e, i, s;
            this.options.closeOnEscape && !t.isDefaultPrevented() && t.keyCode && t.keyCode === V.ui.keyCode.ESCAPE
      ...
      V.ui.formResetMixin,
      {
        ...
        _move: function (t, e) {
          ...
          this.isOpen
            ...
            (i = 'first' === t || 'last' === t ? i['first' === t ? 'prevAll' : 'nextAll'](s).eq(-1) : i[t + 'All'](s).eq(0)).length &&
  ...
  function w(t, e, i) {
    ...
    return null == t
      ? i || !e.def
        ? null
        : e.def
      : ((t = s.floor ? ~~t : parseFloat(t)), s.mod ? (t + s.mod) % s.mod : Math.min(s.max, Math.max(0, t)));
  }
  function $(s) {
    var n = _(),
      o = (n._rgba = []);
    ...
    (_.fn = g.extend(_.prototype, {
      parse: function (n, t, e, i) {
        ...
        return (
          ...
          'string' === s
            ? this.parse($(n) || M._default)
            : 'array' === s
              ? (b(v.rgba.props, function (t, e) {
                  a[e.idx] = w(n[e.idx], e);
                }),
                this)
              : 'object' === s
        ...
        return (
          b(e.props, function (t, e) {
            ...
            null !== n &&
              (null === s
                ? (l[i] = n)
                : (o.mod && (o.mod / 2 < n - s ? (s += o.mod) : o.mod / 2 < s - n && (s -= o.mod)), (l[i] = w((n - s) * a + s, e))));
          }),
          this[t](l)
        );
      },
    ...
    (v.hsla.from = function (t) {
      ...
      return null == t[0] || null == t[1] || null == t[2]
        ...
        : ((e = t[0] / 360),
          ...
          [Math.round(255 * T(s, t, e + 1 / 3)), Math.round(255 * T(s, t, e)), Math.round(255 * T(s, t, e - 1 / 3)), i]);
    }),
    b(v, function (r, t) {
      var e = t.props,
        o = t.cache,
        ...
        b(e, function (o, a) {
          _.fn[o] ||
            (_.fn[o] = function (t) {
              ...
              return 'undefined' === e
                ? n
                : ('function' === e && (e = y((t = t.call(this, n)))),
                  null == t && a.empty
                    ? this
                    : ('string' === e && (e = K.exec(t)) && (t = n + parseFloat(e[2]) * ('+' === e[1] ? 1 : -1)), (s[a.idx] = t), this[i](s)));
            });
        });
    }),
    (_.hook = function (t) {
      ...
      b(t, function (t, s) {
        (g.cssHooks[s] = {
          ...
          (g.fx.step[s] = function (t) {
            t.colorInit || ((t.start = _(t.elem, s)), (t.end = _(t.end)), (t.colorInit = !0)),
              g.cssHooks[s].set(t.elem, t.start.transition(t.end, t.pos));
          });
      });
    }),
    _.hook(
  ...
  (V.effects = { effect: {} }),
    (Z = ['add', 'remove', 'toggle']),
    (tt = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 }),
      ...
      return this.queue(function () {
        var i = V(this),
          ...
          e = (e = o.children ? i.find('*').addBack() : i).map(function () {
            return { el: V(this), start: ot(this) };
          }),
          s = function () {
    ...
    V.fn.extend({
      addClass:
        ((J = V.fn.addClass),
        function (t, e, i, s) {
          return e ? V.effects.animateClass.call(this, { add: t }, e, i, s) : J.apply(this, arguments);
        }),
      removeClass:
        ((Q = V.fn.removeClass),
        function (t, e, i, s) {
          return 1 < arguments.length ? V.effects.animateClass.call(this, { remove: t }, e, i, s) : Q.apply(this, arguments);
        }),
      toggleClass:
        ((G = V.fn.toggleClass),
        function (t, e, i, s, n) {
    ...
    V.expr &&
      ...
      (V.expr.pseudos.animated =
        ((et = V.expr.pseudos.animated),
        function (t) {
          return !!V(t).data(z) || et(t);
        })),
    !0 === V.uiBackCompat &&
      V.extend(V.effects, {
        save: function (t, e) {
      ...
      scaledDimensions: function (t, e, i) {
        ...
        return 0 === e
          ...
          : ((s = 'horizontal' !== i ? (e || 100) / 100 : 1),
            ...
            { height: t.height() * i, width: t.width() * s, outerHeight: t.outerHeight() * i, outerWidth: t.outerWidth() * s });
      },
    ...
    V.fn.extend({
      ...
      toggle:
        ...
        function (t) {
          return A(t) || 'boolean' == typeof t
            ...
            : (((t = O.apply(this, arguments)).mode = 'toggle'), this.effect.call(this, t));
        }),
      cssUnit: function (t) {
        var i = this.css(t),
          s = [];
      ...
      transfer: function (t, e) {
        ...
        l.appendTo('body')
          ...
          .css({ top: s.top - a, left: s.left - o, height: i.innerHeight(), width: i.innerWidth(), position: n ? 'fixed' : 'absolute' })
    ...
    (V.fx.step.clip = function (t) {
      t.clipInit || ((t.start = V(t.elem).cssClip()), 'string' == typeof t.end && (t.end = at(t.end, t.elem)), (t.clipInit = !0)),
        V(t.elem).cssClip({
  ...
  V.effects.define('blind', 'hide', function (t, e) {
    ...
    V.effects.define('drop', 'hide', function (t, e) {
      ...
      V.effects.createPlaceholder(s),
        ...
        s.animate(l, { queue: !1, duration: t.duration, easing: t.easing, complete: e });
    }),
    ...
    V.effects.define('fold', 'hide', function (e, t) {
      ...
      a && (o = (parseInt(a[1], 10) / 100) * p[s ? 0 : 1]),
        ...
        (d.clip[r[0]] = o),
        (d.clip[r[1]] = 0),
        n && (i.cssClip(d.clip), h && h.css(V.effects.clipToBox(d)), (d.clip = c)),
        i
          .queue(function (t) {
